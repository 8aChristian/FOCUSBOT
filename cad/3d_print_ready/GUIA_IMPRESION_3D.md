...
| :--- | :--- | :--- | :--- |
| `01_Carcasa_Cabeza_Frontal` | `cuerpo` | 57.8 x 35.0 x 19.9 mm | Cara de partición plana en la cama. Cavidad interna hacia arriba (Cero soportes en cuna LCD). |
| `02_Carcasa_Cabeza_Trasera` | `cuerpo` | 57.8 x 39.4 x 19.9 mm | Cara de partición plana en la cama. Orejas y alojamiento servo hacia arriba (Cero soportes internos). |
...
| `05_Visor_Frontal_2Pulgadas` | `visor` | 44.7 x 26.7 x 1.2 mm | Placa 100% plana en la cama (Espesor 1.2mm, acabado liso tipo espejo). |
