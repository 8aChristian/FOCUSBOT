...
| :--- | :--- | :--- | :--- |
| `01_Carcasa_Cabeza_Frontal` | `cuerpo` | 58.0 x 35.0 x 20.0 mm | Cara de partición plana en la cama. Cavidad interna hacia arriba (Cero soportes en cuna LCD). |
| `02_Carcasa_Cabeza_Trasera` | `cuerpo` | 58.0 x 39.4 x 20.0 mm | Cara de partición plana en la cama. Orejas y alojamiento servo hacia arriba (Cero soportes internos). |
...
| `05_Visor_Frontal_2Pulgadas` | `visor` | 43.0 x 22.0 x 1.2 mm | Placa 100% plana en la cama (Espesor 1.2mm, acabado liso tipo espejo). |
| `06_Difusor_Luz_Pecho` | `difusor` | 17.6 x 2.8 x 2.0 mm | Plana en la cama. Imprimir en PETG transparente o resina translúcida. |
| `07_Rueda_Traccion_L` | `ruedas` | 34.0 x 34.0 x 7.6 mm | Cilíndrica plana como disco en la cama. Capas concéntricas para máxima resistencia. |
| `08_Rueda_Traccion_R` | `ruedas` | 34.0 x 34.0 x 7.6 mm | Cilíndrica plana como disco en la cama. Capas concéntricas para máxima resistencia. |
