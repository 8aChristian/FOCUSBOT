...
| `02_Carcasa_Cabeza_Trasera` | `cuerpo` | 57.7 x 40.3 x 19.8 mm | Cara de partición plana en la cama. Orejas y alojamiento servo hacia arriba (Cero soportes internos). |
...
| `04_Carcasa_Torso_Tapa` | `cuerpo` | 81.0 x 78.0 x 17.5 mm | Reborde perimetral plano de partición en la cama. Tornamesa de cuello hacia arriba. |
